    ...
    Datos de entrada: opcion_str(Cadena de caracteres), id(Cadena de caracteres), password(Cadena de caracteres), Nombre_producto[25](Arreglo, Cadena de caracter), Descripcion_producto[25](Arreglo, Cadena de caracteres), Ubicacion_producto[25](Arreglo, Cadena de caracteres), Destino_producto[25](Arreglo, Cadena de caracteres), Nombre_vendedor="John Connor"(Cadena de caracteres), Celular_vendedor="662 159 6842"(Cadena de caracteres), Nombre_cliente="Michael Jordan"(Cadena de caracteres), Celular_cliente="661 548 1247"(Cadena de caracteres)
    opcion(Entero), contador_intentos(Entero), salir(Entero), cambiar_cuenta(Entero), Instruccion(Entero), i(Entero), n=2(Entero), Ubicacion(Entero), y(Entero), Producto_elegido(Entero), Destino(Entero), Bloque_switch(Entero), Eliminar(Entero), Producto_eliminado[25](Arreglo, Entero), regresar(Entero), Ajustes(Entero)
    Precio_producto[25](Arreglo, Real), Costo_kilometro=0.25(Real)

    //Variables constantes
    Datos constantes: usuario_administrador = "IDdelAdministrador"(Cadena de caracteres), usuario_vendedor = "IDdelVendedor"(Cadena de caracteres), usuario_cliente = "IDdelCliente"(Cadena de caracteres), pwd_administrador = "Password1"(Cadena de caracteres), pwd_vendedor = "Password2"(Cadena de caracteres), pwd_cliente = "Password3"(Cadena de caracteres), linea_blanco_100 = ""(Cadena de caracteres), linea_blanco_65 = ""(Cadena de caracteres), numero_intentos = 3(Cadena de caracteres)

    //Variables de salida
    Datos de salida: Costo_envio[25](Arreglo, Real), Carrito(Real), Precio_total[25](Arreglo, Real), Distancia_envio[25](Arreglo, Real)

    //Fórmulas
    Fórmulas: Costo_envio[i]=Distancia_envio[i]*Costo_kilometro, Precio_total[i]=Precio_producto+Costo_envio, Carrito=Carrito+Precio_total
