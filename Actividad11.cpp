...
int main()
{
    ...
    int carreras=0, x;
    float distancia_inicial=0, crecimiento=0, distancia_recorrida, distancia;
    char simbolo_interrogacion = 168;
    ...
    while (carreras<=0)
    {
        cout << simbolo_interrogacion << "Cuantas carreras se recorrieron?";
        cin >> carreras;
    }
   
    while (distancia_inicial<=0)
    {
        cout << simbolo_interrogacion << "Cual fue su distancia inicial?";
    ...
    if (carreras>1)
    {
        while(crecimiento<=0)
        {
            cout << simbolo_interrogacion << "Cuanto va a crecer?";
            cin >> crecimiento; 
        }
    }
